...
namespace UdemyRealWorldUnitTest.Test
{
    ...
    public class ProductApiControllerTest
    {
        ...
        [Theory]
        [InlineData(0)]
        public async void GetProducts_IdInValid_returnNtFOund(int productId)
        {
        ...
        public async void GetProduct_IdValid_ReturnOkResult(int productId)
        {
            ...
            var okResult = Assert.IsType<OkObjectResult>(result); //okobjectrsult döndü

            var returnProduct = Assert.IsType<Product>(okResult.Value); //product tipinde
        ...
        public async void PostProduct_ActionExecutes_ReturnCreatedAction()
        {
            ...
            //işlemin tamamlandığını task.completed ile belirttik. Asenkron old. için
        ...
        public async void DeleteProduct_IdInValid_ReturnNotFound(int productId)
        {
            ...
            Assert.IsType<NotFoundResult>(resultNotFound.Result); //interface değil sınıf döndüğü için datanın result ya da vaşues ını almak ozrundayız. 
